<p align="center"><img src="docs/logo.svg" width="96" alt="2CY Agent logo"></p>
...
- **角色卡导入导出**（v0.9 新增）：一键导出为 `.2cy.json`（含人设与形象图），发给朋友导入即可——去中心化的角色卡共享，不需要任何中心服务器
- **应用内更新检查**（v0.9 新增）：启动时静默检查 GitHub Releases，「设置 → 关于」里提示新版本与下载链接；更新只需下载解压覆盖，`data/` 数据不受影响
